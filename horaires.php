      ...
      <div class="row">
        <div class="container mb-5">
          <div class="section-title col-lg-8 col-md-10 ml-auto mr-auto">
            <h3 class="section-title text-center my-5" style="color:#fafafa"><?php echo $arret; ?>L3 - Dallas CRI > Epirey Cap Nord</h3>
          </div>
          <!-- Passage 1 -->
              ...
              <div class="col-md-12">
                <div class="row">
                  <div class="col col-lg-2">
                    <img src="images/transports/divia/L3.png" style="margin-top:11px;">
                  </div>
                  <div class="col-6">
                    <h5 style="color:#fafafa;margin-top:11px;">> Epirey Cap Nord<h4>
                  </div>
                  <div class="col">
